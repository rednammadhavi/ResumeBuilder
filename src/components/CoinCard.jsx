...
const CoinCard = ({ coin }) => {
    ...
    return (
        <div className="bg-gray-800 rounded-xl shadow-lg p-4 hover:scale-105 transform transition-all duration-300">
            <div className="flex items-center space-x-4">
                ...
                <div className="ml-auto text-xs text-gray-400 bg-gray-700 px-2 py-1 rounded">
                    #{market_cap_rank}
                </div>
            </div>
